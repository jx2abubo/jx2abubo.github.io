...
app.controller("portfolioControl", ["$scope", function($scope){
  var $ngSimon = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/SimonSaysSS_zpszhy3jcjw.png","name": "Simon Game", "description": "A Simon Says game with a twist. Strict resets the sequence upon choosing the wrong button, and Nightmare mode removes colors and occasionally shuffles the game. Activate both for a trial harder than Dark Souls(maybe)!", "link": "http://codepen.io/jx2bandito/debug/LxJbLm", "linkText": "Challenge Simon here!", "altText": "A screenshot of my Simon game"};
  var $ngTic= {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/TicTacToe_zps0xmr63yr.png","name": "Tic-Tac-Toe", "description": "Robots have rebelled and the only way to stop them is to beat them in Tic-Tac-Toe. Practice by playing against a fellow human, or face 3 robots leaders who may or may not be based on other fictional robots.", "link": "http://codepen.io/jx2bandito/debug/jyGJvw", "linkText": " Quell their rebellion here!", "altText": "A screenshot of my Tic-Tac-Toe main menu"};
  var $ngTwitch = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/TwitchSS_zps7vdb0i1m.png","name": "Twitch Viewer", "description": "This page uses the Twitch.tv API to see whether streamers are online or offline. Going beyond the suggested requirements from FreeCodeCamp.com, I included a button that removes streamers from the list and added the function to include additional streamers.", "link": "http://codepen.io/jx2bandito/debug/eBaVvp", "linkText": "Check out the Twitch streamers here!"};
  var $ngWiki = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/WikipediaSS_zpsugclrzpo.png","name": "Wikipedia Viewer", "description": "A simple Wikipedia viewer. Uses JavaScript to access Wikipedia API and displays the results on the page. CSS-wise, this project was my introduction to creating elements that changed color on hover.", "link": "http://codepen.io/jx2bandito/debug/BQEbLj", "linkText": " Explore the net's largest encyclopedia here!", "altText":"A screenshot of my Wikipedia searcher"};
  var $ngCalc = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/CalculatorSS_zps2djg6rgu.png","name": "Calculator", "description": "A calculator powered by JavaScript. This project  helped me learn how to create an image with just simple CSS shapes. It was also my first venture into making buttons actually feel like buttons by changing their CSS properties on click.", "link": "http://codepen.io/jx2bandito/debug/VPYPmm", "linkText": "Calculate stuff here!", "altText": "A screenshot of my JS Calculator"};
  var $ngQuote = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/QuoteSS_zpsiuu6zt2p.png","name": "Random Quote Generator", "description": "One of my earliest projects, which explains the terrible design. A quote generator which contains some of my favorite quotes, and a custom, fully functional Tweet button. While it claims to be random, it is not truly random because no quote will be repeated unless the other quotes have already been shown, in which case a new random cycle is begun.", "link": "http://codepen.io/jx2bandito/debug/NbOWxJ", "linkText": " Read the quotes here!", "altText": "A screenshot of my random quote generator"};
