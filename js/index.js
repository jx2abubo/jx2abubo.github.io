...
app.controller("portfolioControl", ["$scope", function($scope){
  var $ngSimon = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/SimonSaysSS_zpszhy3jcjw.png","name": "Simon Game", "description": "A Simon Says game with a twist. Strict resets the sequence upon choosing the wrong button, and Nightmare mode removes colors and occasionally shuffles the game. Activate both for a trial harder than Dark Souls(maybe)!", "link": "http://codepen.io/jx2bandito/full/LxJbLm", "linkText": "Challenge Simon here!", "altText": "A screenshot of my Simon game"};
  ...
  var $ngTwitch = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/TwitchSS_zps7vdb0i1m.png","name": "Twitch Viewer", "description": "This page uses the Twitch.tv API to see whether streamers are online or offline. Going beyond the suggested requirements from FreeCodeCamp.com, I included a button that removes streamers from the list and added the function to include additional streamers. NOTE: AS OF THIS WRITING THE LINK USED FOR THE JSON CALL IS INVALID FOR UNEXPLAINED REASONS.", "link": "http://codepen.io/jx2bandito/full/eBaVvp", "linkText": "Check out the Twitch streamers here!", "altText": "A screenshot of my Twitch viewer app"};
  ...
  var $ngCalc = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/CalculatorSS_zps2djg6rgu.png","name": "Calculator", "description": "A calculator powered by JavaScript. This project  helped me learn how to create an image with just simple CSS shapes. It was also my first venture into making buttons actually feel like buttons by changing their CSS properties on click.", "link": "http://codepen.io/jx2bandito/full/VPYPmm", "linkText": "Calculate stuff here!", "altText": "A screenshot of my JS Calculator"};
  var $ngQuote = {"image": "http://i347.photobucket.com/albums/p460/jx2bandito/QuoteSS_zpsiuu6zt2p.png","name": "Random Quote Generator", "description": "One of my earliest projects, which explains the terrible design. A quote generator which contains some of my favorite quotes, and a custom, fully functional Tweet button. While it claims to be random, it is not truly random because no quote will be repeated unless the other quotes have already been shown, in which case a new random cycle is begun.", "link": "http://codepen.io/jx2bandito/full/NbOWxJ", "linkText": " Read the quotes here!", "altText": "A screenshot of my random quote generator"};
